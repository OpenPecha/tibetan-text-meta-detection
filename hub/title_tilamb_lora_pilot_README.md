...
LoRA adapter on [YoLo2000/TiLamb-7B](https://huggingface.co/YoLo2000/TiLamb-7B) for **title** span extraction from Tibetan text segments.
...
| Benchmark report | [OpenPecha/tibetan-text-meta-detection](https://github.com/OpenPecha/tibetan-text-meta-detection/blob/main/benchmark/report/PILOT_TITLE_BENCHMARK_REPORT.md) |
...
See [docs/TILAMB_TITLE_LORA_INFERENCE.md](https://github.com/OpenPecha/tibetan-text-meta-detection/blob/main/docs/TILAMB_TITLE_LORA_INFERENCE.md) for full options.
...
Download the test split from [ganga4364/tibetan-metadata-llm-sft](https://huggingface.co/datasets/ganga4364/tibetan-metadata-llm-sft) (`title/test.jsonl`).
